  ...
  return (
    <>
      ...
      <div className="mb-8 grid gap-3 sm:grid-cols-3">
        ...
        <Card className="flex items-center gap-4 p-4"><div className="rounded-md bg-indigo-50 p-2.5 text-indigo-600"><BarChart3 size={19} /></div><div><p className="text-[10px] font-bold uppercase tracking-wider text-slate-400">{currencies.length > 1 ? "Coverage currencies" : "Combined market cap"}</p><p className="financial-number mt-1 text-xl font-bold">{marketCapSummary}</p></div></Card>
      </div>
